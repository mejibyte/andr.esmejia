...
module ApplicationHelper
  ...
  def meta_description(some_description)
    content_for :head do
      tag :meta, name: :description, content: some_description.to_s
    end
  end
  ...
  def contact_me_url
    ...
    "&body=" + CGI::escape("And I wanted to tell you that...").gsub("+", "%20")).html_safe
  end
end
